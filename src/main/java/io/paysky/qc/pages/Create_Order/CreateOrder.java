...
public class CreateOrder {
    ...
    public void Create_Order() throws InterruptedException {
        ...
        Thread.sleep(10000);
        String orderNumber = driver.findElement(By.xpath("/html/body/app-root/section/div/div/div/app-main-landing/div/app-index/div/section/div/div[3]/a[1]/div[1]/div[2]/span[2]")).getText();
